...
public class ReviewVO {
	...
	public String toString() {
		return "ReviewVO [r_num=" + r_num + ", r_date=" + r_date + ", r_modify_date=" + r_modify_date + ", party_num="
				+ party_num + ", r_content=" + r_content + ", r_photoname=" + r_photoname + ", mem_num=" + mem_num
				+ ", mem_name=" + mem_name + ", mem_id=" + mem_id + ", photo_name=" + photo_name + ", party_name="
				+ party_name + "]";
	}
